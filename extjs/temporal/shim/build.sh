...
# result). Same pipeline as extjs/firebase/shim/build.sh, for the same reason: the bundle is
...
echo "built extjs/temporal/vendor/temporal-shim.js ($(wc -c < ../vendor/temporal-shim.js) bytes)"
